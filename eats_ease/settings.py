...
SECRET_KEY = 'django-insecure-c7^y@$-bnpnnp3&uvd)ywx%et)stm2&g_@0z)22vm1!=05o)na'
...
DATABASES = {
    'default': {
        ...
        'PORT': '5432',       # Set to the port where your PostgreSQL server is listening
    }
}
...
JAZZMIN_SETTINGS = {
    "site_logo": None,
    "login_logo": "icons/admin.png",
    "site_icon": None,
    "site_title": "EatsEase Admin",
